  ...
  <div class="project-hero grid">
    <div class="project-hero-top">
      <div class="project-hero-title-wrapper">
        <h1 class="project-hero-title" :key="animationKey" v-html="content.title"></h1>
      </div>
...
.project-hero {
  ...
  &-title {
    ...
    /* 🎨 AGREGADO EXTRA: Añadimos un pequeño margen de seguridad inferior por si el título rompe en dos líneas */
