  ...
  const SERVICES_EN = [
    { name: "Custom Automation Architect" },
    { name: "Conversational Bots & AI Agents" },
    { name: "Enterprise API Integrations" },
    { name: "End-to-End Solutions" },
    { name: "Business-Driven Code" },
  ...
  // 1. Agregamos el arreglo estático en español con tus textos exactos
  const SERVICES_ES = [
    { name: "Arquitecto de Automatización a Medida" },
    { name: "Bots Conversacionales y Agentes de IA" },
    { name: "Integraciones de API Empresariales" },
    { name: "Soluciones de Extremo a Extremo" },
    { name: "Código Orientado a Negocios" },
  ] as const satisfies { name: string }[];

  // 2. Modificamos el computed para que evalúe los tres idiomas limpiamente
  const services = computed(() => {
    if (locale.value === "es") return SERVICES_ES;
